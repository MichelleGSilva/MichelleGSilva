...
### 🌩️ StormSync
Projeto focado em organização, lógica de sistema e estruturação de funcionalidades.
...
### 🔍 Google Clone
Clone da interface do Google utilizando **HTML, CSS e JavaScript**, com foco em layout, responsividade e DOM.
